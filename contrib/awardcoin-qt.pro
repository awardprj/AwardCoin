...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/awardcoin-cli.cpp \
           src/awardcoin-tx.cpp \
           src/awardcoin.cpp \
           src/db.cpp \
           ...
           src/qt/awardcoin.cpp \
           src/qt/awardcoinstrings.cpp \
...
RESOURCES += src/qt/awardcoin.qrc src/qt/awardcoin_locale.qrc

TRANSLATIONS += src/qt/locale/awardcoin_bg.ts \
                src/qt/locale/awardcoin_de.ts \
                src/qt/locale/awardcoin_en.ts \
                src/qt/locale/awardcoin_es.ts \
                src/qt/locale/awardcoin_fi.ts \
                src/qt/locale/awardcoin_fr.ts \
                src/qt/locale/awardcoin_it.ts \
                src/qt/locale/awardcoin_ja.ts \
                src/qt/locale/awardcoin_pl.ts \
                src/qt/locale/awardcoin_pt.ts \
                src/qt/locale/awardcoin_ru.ts \
                src/qt/locale/awardcoin_sk.ts \
                src/qt/locale/awardcoin_sv.ts \
                src/qt/locale/awardcoin_vi.ts \
                src/qt/locale/awardcoin_zh_CN.ts \
                src/qt/locale/awardcoin_zh_TW.ts
