Contributing to AwardCoin Core
============================

The AwardCoin Core project operates an open contributor model where anyone is
...
The following applies to code changes to the AwardCoin Core project, and is not to be
confused with overall AwardCoin Network Protocol consensus changes.

Whether a pull request is merged into AwardCoin Core rests with the project merge
...
Patches that change AwardCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the AwardCoin consensus, it must have been
...
The project leader is the release manager for each AwardCoin Core release.
