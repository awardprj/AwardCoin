...
This mechanism has been integrated into Bitcore-Node-AwardCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/AwardCoin-Project/insight-api-awardcoin#web-socket-api](https://github.com/AwardCoin-Project/insight-api-awardcoin#web-socket-api) 
* API: [https://github.com/AwardCoin-Project/insight-api-awardcoin#swifttx-transactions](https://github.com/AwardCoin-Project/insight-api-awardcoin#swifttx-transactions) 
...
By default, the AwardCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the AwardCoin Core daemon:
