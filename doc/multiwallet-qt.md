...
In order to support loading of multiple wallets in awardcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is awardcoin.cpp.
...
Changes to awardcoin.cpp
----------------------
awardcoin.cpp is the entry point into awardcoin-qt, and as such, will require some minor modifications to provide hooks for
