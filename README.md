...
It is recommended [use the shell script](https://github.com/awardprj/awr-install) to install a AwardCoin Masternode on a Linux server running Ubuntu 14.04, 16.04, 18.04
