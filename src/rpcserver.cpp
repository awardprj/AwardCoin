...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop AwardCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "AwardCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* AwardCoin features */
        {"awardcoin", "masternode", &masternode, true, true, false},
        {"awardcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"awardcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"awardcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"awardcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"awardcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"awardcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"awardcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"awardcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"awardcoin", "startmasternode", &startmasternode, true, true, false},
        {"awardcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"awardcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"awardcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"awardcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"awardcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"awardcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"awardcoin", "mnbudget", &mnbudget, true, true, false},
        {"awardcoin", "preparebudget", &preparebudget, true, true, false},
        {"awardcoin", "submitbudget", &submitbudget, true, true, false},
        {"awardcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"awardcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"awardcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"awardcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"awardcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"awardcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"awardcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"awardcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"awardcoin", "mnsync", &mnsync, true, true, false},
        {"awardcoin", "spork", &spork, true, true, false},
        {"awardcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> awardcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:19915/\n";
}
