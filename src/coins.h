...
/** 
    ...
    ****Note - for AwardCoin we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of awardcoin coming in to a transaction
