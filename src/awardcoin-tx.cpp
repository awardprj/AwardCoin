...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Awardcoin Core awardcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  awardcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded awardcoin transaction") + "\n" +
                               "  awardcoin-tx [options] -create [commands]   " + _("Create hex-encoded awardcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded awardcoin transaction
