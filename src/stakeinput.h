...
#ifndef AwardCoin_STAKEINPUT_H
#define AwardCoin_STAKEINPUT_H
...
public:
    ...
    virtual bool IsZAWR() = 0;
    virtual CDataStream GetUniqueness() = 0;
};


// zAWRStake can take two forms
...
public:
    ...
    bool IsZAWR() override { return true; }
...
public:
    ...
    bool CreateTxIn(CWallet* pwallet, CTxIn& txIn, uint256 hashTxOut = 0) override;
    bool CreateTxOuts(CWallet* pwallet, vector<CTxOut>& vout, CAmount nTotal) override;
    bool IsZAWR() override { return false; }
};


#endif //AwardCoin_STAKEINPUT_H
