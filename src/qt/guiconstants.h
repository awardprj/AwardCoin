...
/* Awardcoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "AwardCoin"
#define QAPP_ORG_DOMAIN "awardcoin.cc"
#define QAPP_APP_NAME_DEFAULT "AwardCoin-Qt"
#define QAPP_APP_NAME_TESTNET "AwardCoin-Qt-testnet"
