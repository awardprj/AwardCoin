                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("AwardCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a AwardCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and awardcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zAWR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About AwardCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about AwardCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for AwardCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your AwardCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified AwardCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a AwardCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the AwardCoin Core help message to get a list with possible AwardCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("AwardCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to AwardCoin network", "", count));
}
...
{
    QString strTitle = tr("AwardCoin Core"); // default title
