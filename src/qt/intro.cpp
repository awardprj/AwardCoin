...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("AwardCoin Core"),
     ...
     * override -datadir in the awardcoin.conf file in the default data directory
     * (to be consistent with awardcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
