...
/** Utility functions used by the AwardCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render AwardCoin addresses in monospace font
...
// Parse "awardcoin:" URI into recipient object, return true on successful parsing
